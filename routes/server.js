...
//  , settings = require('../settings.js')  // file doesn't seem to exist
//  , db = mongoskin.db(settings.MONGODB_URL, settings.MONGODB_OPTIONS) // commenting because settings.js doesn't exist
