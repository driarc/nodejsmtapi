    ...
    case 'javascript':
        try {
            ...
            if (leftOverParameters.has('js')) {
                ...
                _result = {
                    'Error': 'no valid Js key/value pair'
                };
            }
        }
        catch (err) {
    ...
    if (paramsFromDB) {
        ...
        request({
            ...
            if (response.statusCode == 200) {
                ...
                loopWidRequests(--rot, fullURL, mulWidResKeys, mulWidVal, valRetCol, {
...
//This will evaluate a function with the set of variables given to it as an object (vars)
...
//Checks whether given value is a valid numeric or not (even if it's represented as string)
...
//Getting vars(Object) from parameters(hashmap) and parsing value numerics to their format than in string
...
//Get property value from object (with case-insensitive search) 
...
//To check if object has property prop (case insensitive check)
...
//To check if object is empty or no property lies for this object
...
//Converting normal object key/value pair to DTO format ParameterName/ParameterValue
...
//Merging two objects(result_objects in executethis multiple)
